 ...
 */
                        ...
                        <div class="row g-2 library-post-info">
                            <div class="col-12">
                             <!--   <div class="row justify-content-between align-items-center mb-2">
                                ...
                                <!-- <span class="col-6 text-end"><button type="button"  class="btn more-btn btn-typ1 me-0 ms-auto" id="downloadButton" data-fileurl="<?php echo $fileName; ?>">Download</button></span> -->
                                <?php //} ?> 
                                </div>
                            </div>
                        </div>
 ...
 <form name="downloadAll" action="" method="post">
                    ...
                    <div class="col-12">
                        <button class="btn more-btn more-btn-blue btn-typ1 ms-auto me-0" id="continueButton" type="submit" name="DownloadClick">
                        <?php if(count($selectedFiles) >1){ ?>DownloadAll<?php } 
                        else{
                            ?>download<?php
                        }?>
                        </button>
