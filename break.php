...
try {
    $query1 = "SELECT * FROM `cms` WHERE  `menu_id` = 14 ORDER BY `created_at` DESC ";
        ...
        <div class="container">
                    ...
                    <li class="news-list-item">
                        <div class="row g-lg-5 g-3">
                            ...
                            <div class="news-text-content">
                                ...
                                <?php
                                $date = $h['created_at']; // Assuming $h['created_at'] contains the date-time value
            ...
            <ol class="post-list-bottom">
                ...
                if (count($history) == $itemsPerPage && $currentPage < $totalPages) {
                    ...
                    $nextPageQuery = "SELECT * FROM `cms` WHERE `menu_id` = 14 ORDER BY `created_at` DESC LIMIT $nextPageOffset, $itemsPerPage";
            ...
            <div class="pagination">
                ...
                <ul>
                    ...
                    $pageRange = 5; // You can adjust this value to display a different number of page numbers
