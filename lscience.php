...
try {
    $query1 = "SELECT * FROM `cms` WHERE `menu_id` = 15 ORDER BY `created_at` DESC ";
...
<body>
    <section class="page-title-section mb-lg-5 mb-4">
        <div class="container">
            <h2 class="hd-typ1">Latest Science and Reports</h2>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <ol class="post-list-bottom">
                ...
                if (count($history) == $itemsPerPage && $currentPage < $totalPages) {
                    ...
                    $nextPageQuery = "SELECT * FROM `cms` WHERE `menu__-` LIKE 'Latest Sci%' LIMIT $nextPageOffset, $itemsPerPage";
