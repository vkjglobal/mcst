...
try {
    ...
    //nimmi
    $query5 = "SELECT * FROM header_slider where status = 0 ORDER BY id DESC ";
    $stmt = $conn->prepare($query5);
    $stmt->execute();
    $header_styles=$stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="row">
            <div class="col-lg-6 tab-abs">
             <div class="d-flex h-100 flex-column justify-content-between px-1">
                ...
                <a href="header_slider_listing.php?id=<?php echo $hs['id']; ?>" class="btn more-btn">Learn More</a>
                
                <!-- You can add other content here as needed -->
            </div>
            </div>
            <div class="col-lg-6">
            <div class="img-wrp mb-xl-5" style="background-image: url(admin/uploads/<?php echo $hs['image']; ?>);">
