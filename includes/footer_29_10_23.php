...
Majuro MH, 96960
                        ...
                        <a href="tel:+(692) 625-3394" class="mb-4">+(692) 625-3394</a>
                    ...
                    <div class="row footer-links">
                        <div class="col-sm-4 col-6 mb-md-0 mb-3">
                            <ul>
                                ...
                                <li>
                                    <a href="about-us.php?id=ODAz">Our Team</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-4  col-6 mb-md-0 mb-3">
                             <ul>
                                ...
                                <li>
                                    <a href="hlpu.php?id=ODI5">Virtual Ocean Dialogues 2020</a>
                                </li>
                                <li>
                                    <a href="hlpu.php?id=MjAzMw==">E-Bwebwenato Series</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <ul>
                                ...
                                <li>
                                    <a href="partners-listing.php?id=ODI3"><strong>Partners</strong></a>
                                </li>
                                <li>
