...
//WHERE c1._id = :your_parent_category_id
    ...
    // }
    //  public function updateProfile($id,$email,$fname,$lname,$image){
    //      $query = "UPDATE users SET first_name= ?,last_name= ?,email = ? ,phone = ?,image= ?,address= ? WHERE id = ?";
    //     $params = [ $fname,$lname,$email,$phone,$image,$address,$adminid];
