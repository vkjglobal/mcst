...
?><script>
    window.location="index1.php";exit;
</script>
    <?php
}
@include 'config.php';
...
if (isset($_POST['login'])) {
    ...
    if ($query->rowCount() > 0) {
        ...
        $_SESSION['login'] = $_POST['email'];
         echo "<script type='text/javascript'> document.location = 'index1.php';exit; </script>";
      //  header("Location: index1_sou.php"); // Redirect on successful login
        exit();
    } else {
