...
$sql="INSERT INTO users( first_name,last_name,email,passwor,user) VALUES(:fname,:lname,:email,:passwor,:user)";
...
<head>
    ...
    <script>
        function clearForm() {
            // Reset the form by setting all input fields to an empty string
    ...
    <script>
        document.getElementById("myForm").addEventListener("submit", function(event)) {
            ...
            if (password !== confirm_password) {
                // Passwords don't match, show a popup
