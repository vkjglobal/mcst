                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="border-primary text-center rounded p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <form class="d-none d-md-flex ms-4" method="GET" action="category-list.php">
...
{				?>		
						  <tr>
                            ...
                            <td><?php echo isset($result->{'parent__-'}) ? htmlentities($result->{'parent__-'}) : ''; ?></td>
							<td><?php echo htmlentities($result->category);?></td>
                            <td>
                                            <div class="d-flex action">
                                               <a class="btn text-secondary edit" href="updatecategory.php?uid=<?php echo htmlentities($result->_id); ?>">
                                                    <i class="fa fa-pen">Edit</i>
                                                </a>
                                                <button type="button" class="btn text-secondary delete">
                                                <a class="btn text-secondary delete" href="deletecategory.php?_id=<?php echo htmlentities($result->_id); ?>" onclick="return confirm('Are you sure you want to delete this record?');">   
