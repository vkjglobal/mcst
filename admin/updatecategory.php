...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE categories set category=:menu,updated_at=:update_date WHERE _id=:uid";
    $sql = $dbh->prepare($sql);
    ...
    if ($sql->rowCount() > 0) {
        ...
        header("Location: category-list.php"); // Change "success_page.php" to the actual page URL
            ...
            <div class="min-vh-100">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row border-primary rounded mx-0 p-3">
                        ...
                        <?php 
$uid=intval($_GET['uid']);
$sql = "SELECT * from categories where _id=:uid";
...
{	?>
    ...
    <option value="<?php echo htmlentities($result->parent_category_id); ?>">
    <?php echo htmlentities($result->{'parent__-'}); ?>
    </option>
</select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                ...
                                                <input type="text" class="form-control border" name="menu" required="" value="<?php echo htmlentities($result->category);?>">
                                            </div>
                                        </div>
                                    </div>
                                    <script>
