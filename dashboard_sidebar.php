...
?>
    ...
    $member_NAme    =  $res['first_name'].$res['last_name'];
     $imagePic    =   $res['profile_img'];
     $profileImageURLPic =     "uploads/images/profileimg/".$imagePic;
                    
            if ((empty($imagePic)) || (!file_exists($profileImageURLPic))) {
              
                $profileImageURLPic = "images/avatar-new.png"; // URL of the dummy image
                        ...
                        <div
                            ...
                            <div class="mb-3 d-flex flex-lg-column align-items-center">
                                <div class="img-wrp text-center mb-2">
                                    <img src="<?php echo $profileImageURLPic; ?>" alt="" class="rounded-circle">
                                </div>
                        ...
                        <ul class="list-group w-100">
                            <li class="dropdown list-group-item list-group-item-action bg-transparent border-0 py-1">
                                ...
                                <ul class="dropdown-menu bg-transparent border-0 position-static">
                                    ...
                                    <ul class="submenu">
                                        <li><a class="dropdown-item" href="published-posts.php">Published Posts</a></li>
                                        <li><a class="dropdown-item" href="unpublished-posts.php">Unpublished Posts</a></li>
                                    </ul>
