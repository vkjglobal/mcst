...
try {
    ...
    $query3 = "SELECT * FROM projects where status LIKE 'Curr%' ORDER BY _id DESC ";
    $stmt = $conn->prepare($query3);
    $stmt->execute();
            ...
            <div class="col-lg-6 tab-abs">
             <div class="d-flex h-100 flex-column justify-content-between px-1">
                ...
                <?php
                    ...
                    $content = strip_tags($partner['content']);
                ...
                <a href="projects-listing.php?id=<?php echo base64_encode($partner['_id']); ?>" class="btn more-btn">Learn More</a>
                
                <!-- You can add other content here as needed -->
            </div>
            </div>
            <div class="col-lg-6">
            <div class="img-wrp mb-xl-5" style="background-image: url(<?php echo $partner['image']; ?>);">
        ...
        <div class="row g-xl-5">
            ...
            <div class="col-lg-6 ps-xl-5">
                ...
                <div class="d-flex justify-content-lg-start">
                    <a href="projects-listing.php?id=<?php echo base64_encode($projects[0]['_id']); ?>" class="btn more-btn ">More Projects</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <?php foreach ($blog as $b): ?>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="http://mcst-rmi.org/blog/shipping-solutions-a-call-to-arms/" class="post">
                        <span class="img-wrp">
                        <img src="images/img9.png" alt="">
                       <!-- <img src="<?php echo $b['post_excerpt']; ?>" alt=""> -->
                        </span>
                        <?php
                        ...
                        ?> 
                        <span class="more-link w-100">Learn More</span>
                    </a>
                </div>
                <?php endforeach; ?>
            </div>
