...
<div id="single_post_wrap">
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
      <h3 class="text-capitalize font-light darkcolor bottom15"><?php the_title(); ?></h2>
    <div class="time_and_author bottom10">  <i class="fa fa-calendar"></i> <?php the_time('F jS, Y') ?> by <i class="fa fa-user-o"></i>   <?php the_author() ?></div>
 
    <div class="post_content"><p class="bottom35"><?php the_content(); ?></p></div>
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 text-center">
            <ul class="social-icons bottom25">
               <li><a href="https://www.facebook.com/MicronesianCenterforSustainableTransport"><i class="fa fa-facebook"></i> </a> </li>
               <li><a href="https://twitter.com/mcst_rmi"><i class="fa fa-twitter"></i> </a> </li>
