<?php
function fiona_blog_repeater_register( $wp_customize ) {

	require_once( get_template_directory().'/inc/customizer-repeater/class/customizer-repeater-control.php' );
	
}
add_action( 'customize_register', 'fiona_blog_repeater_register' );

function fiona_blog_repeater_sanitize($input){
