/* global jQuery */
/* global wp */
function fiona_blog_media_upload(button_class) {
    'use strict';
 ...
 *** Generate unique id ***
 *********************************************/
function fiona_blog_customizer_repeater_uniqid(prefix, more_entropy) {
    'use strict';
 ...
 *** General Repeater ***
 *********************************************/
function fiona_blog_customizer_repeater_refresh_social_icons(th) {
    'use strict';
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + fiona_blog_customizer_repeater_uniqid();
    ...
    fiona_blog_customizer_repeater_refresh_general_control_values();
}


function fiona_blog_customizer_repeater_refresh_general_control_values() {
    'use strict';
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (!id) {
                id = 'social-repeater-' + fiona_blog_customizer_repeater_uniqid();
            ...
            if (text !== '' || image_url !== ''  || image_url2 !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== '' || color !== '') {
                values.push({
                    ...
                    'color': color,
                    'color2': color2,
                    'text': fionaescapeHtml(text),
                    'link': link,
                    'text2': fionaescapeHtml(text2),
                    'link2': link2,
                    'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
                    'choice': choice,
					'image_url2': image_url2,
                    'title': fionaescapeHtml(title),
                    'subtitle': fionaescapeHtml(subtitle),
					'slide_align': fionaescapeHtml(slide_align),
                    'social_repeater': fionaescapeHtml(social_repeater),
                    'id': id,
                    'shortcode': fionaescapeHtml(shortcode)
                });
            }
...
jQuery(document).ready(function () {
    'use strict';
    var fiona_blog_theme_controls = jQuery('#customize-theme-controls');
    fiona_blog_theme_controls.on('click', '.customizer-repeater-customize-control-title', function () {
    ...
    fiona_blog_theme_controls.on('change', '.icp',function(){
        fiona_blog_customizer_repeater_refresh_general_control_values();
        return false;
    });
	
	fiona_blog_theme_controls.on('change','.customizer-repeater-slide-align', function(){
		fiona_blog_customizer_repeater_refresh_general_control_values();
        return false;
		
	});
	
	fiona_blog_theme_controls.on('change','.customizer-repeater-image2-control', function(){
		fiona_blog_customizer_repeater_refresh_general_control_values();
        return false;
    ...
    fiona_blog_theme_controls.on('change', '.customizer-repeater-image-choice', function () {
    ...
    fiona_blog_media_upload('.customizer-repeater-custom-media-button');
     ...
     *
     */
    fiona_blog_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        var split_add_more_button=jQuery(this).text();
        var split_add_more_button_split=split_add_more_button.substr(4, 12);
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + fiona_blog_customizer_repeater_uniqid();
		
		if(split_add_more_button_split=="Add New Soci")
        {
        if(jQuery('#exist_fiona_blog_Social').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_fiona_blog_Social').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_fiona_blog_Social').val())+1;
         jQuery('#exist_fiona_blog_Social').val(new_service_add_val);  
        }
        }
    ...
    fiona_blog_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_fiona_blog_Social').val(parseInt(jQuery('#exist_fiona_blog_Social').val())-1); 
                }
    ...
    fiona_blog_theme_controls.on('keyup', '.customizer-repeater-title-control', function () {
        fiona_blog_customizer_repeater_refresh_general_control_values();
    });
    ...
    fiona_blog_theme_controls.on('keyup', '.customizer-repeater-subtitle-control', function () {
        fiona_blog_customizer_repeater_refresh_general_control_values();
    });

    fiona_blog_theme_controls.on('keyup', '.customizer-repeater-shortcode-control', function () {
        fiona_blog_customizer_repeater_refresh_general_control_values();
    });

    fiona_blog_theme_controls.on('keyup', '.customizer-repeater-text-control', function () {
        fiona_blog_customizer_repeater_refresh_general_control_values();
    });

    fiona_blog_theme_controls.on('keyup', '.customizer-repeater-link-control', function () {
        fiona_blog_customizer_repeater_refresh_general_control_values();
    });

    fiona_blog_theme_controls.on('keyup', '.customizer-repeater-text2-control', function () {
        fiona_blog_customizer_repeater_refresh_general_control_values();
    });

    fiona_blog_theme_controls.on('keyup', '.customizer-repeater-link2-control', function () {
        fiona_blog_customizer_repeater_refresh_general_control_values();
    });
    ...
    /*----------------- Socials Repeater ---------------------*/
    fiona_blog_theme_controls.on('click', '.social-repeater-add-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-social-repeater-' + fiona_blog_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
    ...
    fiona_blog_theme_controls.on('click', '.social-repeater-remove-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var repeater = jQuery(this).parent().parent();
        th.remove();
        fiona_blog_customizer_repeater_refresh_social_icons(repeater);
        return false;
    });

    fiona_blog_theme_controls.on('keyup', '.customizer-repeater-social-repeater-link', function (event) {
        event.preventDefault();
        var repeater = jQuery(this).parent().parent();
        fiona_blog_customizer_repeater_refresh_social_icons(repeater);
        return false;
    ...
    fiona_blog_theme_controls.on('change', '.customizer-repeater-social-repeater-container .icp', function (event) {
        event.preventDefault();
...
function fionaescapeHtml(string) {
    'use strict';
    //noinspection JSUnresolvedFunction
    string = String(string).replace(new RegExp('\r?\n', 'g'), '<br />');
    string = String(string).replace(/\\/g, '&#92;');
    return String(string).replace(/[&<>"'\/]/g, function (s) {
        return fionaentityMap[s];
    });
