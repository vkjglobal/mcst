(function ($) {
    'use strict';
    wp.fionablogcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                fiona_blog_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.fionablogcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.fionablogcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.fionablogcustomizerRepeater.iconPickerToggle($(this));
        });
