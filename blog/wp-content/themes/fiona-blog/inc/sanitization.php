 ...
 */
function fiona_blog_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function fiona_blog_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function fiona_blog_sanitize_html( $html ) {
 ...
 */
function fiona_blog_sanitize_image( $image, $setting ) {
 ...
 */
function fiona_blog_sanitize_nohtml( $nohtml ) {
 ...
 */
function fiona_blog_sanitize_number_absint( $number, $setting ) {
 ...
 */
function fiona_blog_sanitize_select( $input, $setting ) {
 ...
 */
function fiona_blog_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function fiona_blog_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function fiona_blog_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
 ...
 *                    the setting default.
 */
function fiona_blog_sanitize_range_value( $number, $setting ) {
